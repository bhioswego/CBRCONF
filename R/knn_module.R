...
knn_module <- function(CBRContainer, k = 5, n.folds = 10) {
  ...
  for(i in 1:n.folds) {
    ...
    training_risk_groups$`Risk Group` <- ile(training_neighbor_times$time, 3)
    ...
    testing_risk_groups$`Risk Group` <- ile(testing_neighbor_times$time, 3)
